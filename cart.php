...
<section class="shopping-cart">
    ...
    <div  class="box">
        ...
        <div class="price">MRP <?php echo $fetch_cart['price']; ?>/-</div>
        ...
        <div class="sub-total"> sub-total : <span>MRP <?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
    </div>
    <?php
    ...
    <div class="cart-total">
        <p>grand total : <span>MRP <?php echo $grand_total; ?>/-</span></p>
